...
//        private List<Deplacement> moveHistory;
...
//    {
//        InitializeComponent();
//            moveHistory = new List<Deplacement>();
//            // Définir les joueurs
//            player1 = new Joueur("Player 1", CellState.X);
//            player2 = new Joueur("Player 2", CellState.O);
...
//            moveHistory.Add(new Deplacement(currentPlayer, row, col));
...
//        private bool HasWon(Joueur player)
//        {
//            bool hasWon = false;
